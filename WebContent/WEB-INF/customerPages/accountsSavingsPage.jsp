...
<script src="<c:url value="/resources/js/jspdf.table.js" />"></script>
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <h4><center>Transaction History</center></h4>
                        ...
                        <form class="form-horizontal" action="SavingsAccount" method='POST' onSubmit="return checkInputOr()">
                                            <div class="row">
	...
	<button type="button" onclick="generatePDF(${savingsAccount.account_number},${savingsAccount.balance})" class="btn btn-primary">Download statements</button></div>
    ...
    function generatePDF(num,bal) {    
        function generatePDF() {
              ...
              var header = function(data) {
                ...
                pdf.text(("Transaction Summary for savings account\t\t\t\t\tDate:"+today+"\n"+"Account Number:  "+num+"\n"+"Account Balance:  $"+bal), data.settings.margin.left, 50);
              }
              ...
              pdf.save("Transaction_Summary_Savings_"+num+"_"+today+".pdf");
            };
            generatePDF();
        }
</script>
